...
dependencies {
    testImplementation(project(":finch-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../finch-kotlin-core/src/main/resources/META-INF/proguard/finch-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../finch-kotlin-core/src/main/resources/META-INF/proguard/finch-kotlin-core.pro",
