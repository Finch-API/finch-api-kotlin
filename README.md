...
[![Maven Central](https://img.shields.io/maven-central/v/com.tryfinch.api/finch-kotlin)](https://central.sonatype.com/artifact/com.tryfinch.api/finch-kotlin/4.1.0)
...
```kotlin
implementation("com.tryfinch.api:finch-kotlin:4.1.0")
```
...
To set a documented parameter or property to an undocumented or not yet supported _value_, pass a [`JsonValue`](finch-kotlin-core/src/main/kotlin/com/tryfinch/api/core/JsonValue.kt) object to its setter:
