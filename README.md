...
[![Maven Central](https://img.shields.io/maven-central/v/com.tryfinch.api/finch-kotlin)](https://central.sonatype.com/artifact/com.tryfinch.api/finch-kotlin/5.4.0)
[![javadoc](https://javadoc.io/badge2/com.tryfinch.api/finch-kotlin/5.4.0/javadoc.svg)](https://javadoc.io/doc/com.tryfinch.api/finch-kotlin/5.4.0)
...
The REST API documentation can be found on [developer.tryfinch.com](https://developer.tryfinch.com/). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.tryfinch.api/finch-kotlin/5.4.0).
...
```kotlin
implementation("com.tryfinch.api:finch-kotlin:5.4.0")
```
