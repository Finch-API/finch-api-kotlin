...
internal class PayStatementResponseBodyTest {
    ...
    fun ofUnionMember0() {
        ...
        assertThat(payStatementResponseBody.unionMember0()).isEqualTo(unionMember0)
        assertThat(payStatementResponseBody.batchError()).isNull()
        assertThat(payStatementResponseBody.unionMember2()).isNull()
    }
    ...
    fun ofBatchError() {
        ...
        assertThat(payStatementResponseBody.unionMember0()).isNull()
        assertThat(payStatementResponseBody.batchError()).isEqualTo(batchError)
        assertThat(payStatementResponseBody.unionMember2()).isNull()
    }
    ...
    fun ofUnionMember2() {
        ...
        assertThat(payStatementResponseBody.unionMember0()).isNull()
        assertThat(payStatementResponseBody.batchError()).isNull()
        assertThat(payStatementResponseBody.unionMember2()).isEqualTo(unionMember2)
    }
