...
class SandboxConnectionCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = SandboxConnectionCreateParams.builder()
          .providerId("provider_id")
          .authenticationType(SandboxConnectionCreateParams.AuthenticationType.CREDENTIAL)
          .employeeSize(0L)
          .addProduct("string")
      ...
      assertThat(body.authenticationType()).isEqualTo(SandboxConnectionCreateParams.AuthenticationType.CREDENTIAL)
