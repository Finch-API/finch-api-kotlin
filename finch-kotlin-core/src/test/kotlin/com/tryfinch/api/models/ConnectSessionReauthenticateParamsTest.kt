...
class ConnectSessionReauthenticateParamsTest {
    ...
    @Test
    fun body() {
      val params = ConnectSessionReauthenticateParams.builder()
          .connectionId("connection_id")
          .minutesToExpire(0L)
          .addProduct(ConnectSessionReauthenticateParams.ConnectProducts.COMPANY)
          .redirectUri("https://example.com")
      ...
      assertThat(body.products()).isEqualTo(listOf(ConnectSessionReauthenticateParams.ConnectProducts.COMPANY))
