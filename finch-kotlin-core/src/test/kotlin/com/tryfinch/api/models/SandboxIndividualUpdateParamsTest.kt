...
class SandboxIndividualUpdateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.emails()).isEqualTo(listOf(SandboxIndividualUpdateParams.Email.builder()
          .data("data")
          .type(SandboxIndividualUpdateParams.Email.Type.WORK)
          .build()))
      ...
      assertThat(body.phoneNumbers()).isEqualTo(listOf(SandboxIndividualUpdateParams.PhoneNumber.builder()
          .data("data")
          .type(SandboxIndividualUpdateParams.PhoneNumber.Type.WORK)
          .build()))
      assertThat(body.preferredName()).isEqualTo("preferred_name")
      assertThat(body.residence()).isEqualTo(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
