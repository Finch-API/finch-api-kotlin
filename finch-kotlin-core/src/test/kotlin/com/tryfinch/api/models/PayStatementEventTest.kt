...
internal class PayStatementEventTest {
    ...
    fun create() {
        ...
        assertThat(payStatementEvent.connectionId()).isEqualTo("connection_id")
        assertThat(payStatementEvent.entityId()).isEqualTo("entity_id")
        ...
        assertThat(payStatementEvent.eventType())
            .isEqualTo(PayStatementEvent.EventType.PAY_STATEMENT_CREATED)
    }
