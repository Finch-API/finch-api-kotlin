...
class IntrospectionTest {
    ...
    fun createIntrospection() {
      val introspection = Introspection.builder()
          .accountId("account_id")
          .addAuthenticationMethod(Introspection.AuthenticationMethod.builder()
              .connectionStatus(Introspection.AuthenticationMethod.ConnectionStatus.builder()
                  .message("message")
          ...
          .connectionStatus(Introspection.ConnectionStatus.builder()
              .message("message")
              .status(ConnectionStatusType.PENDING)
              .build())
      ...
      assertThat(introspection.authenticationMethods()).containsExactly(Introspection.AuthenticationMethod.builder()
          .connectionStatus(Introspection.AuthenticationMethod.ConnectionStatus.builder()
              .message("message")
              .status(ConnectionStatusType.PENDING)
              .build())
      ...
      assertThat(introspection.connectionStatus()).isEqualTo(Introspection.ConnectionStatus.builder()
          .message("message")
          .status(ConnectionStatusType.PENDING)
          .build())
      assertThat(introspection.connectionType()).isEqualTo(Introspection.ConnectionType.PROVIDER)
      assertThat(introspection.customerEmail()).isEqualTo("customer_email")
      assertThat(introspection.customerId()).isEqualTo("customer_id")
      assertThat(introspection.customerName()).isEqualTo("customer_name")
