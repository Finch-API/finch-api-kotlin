...
class AutomatedAsyncJobTest {
    ...
    fun createAutomatedAsyncJob() {
      ...
      assertThat(automatedAsyncJob.completedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(automatedAsyncJob.params()).isEqualTo(AutomatedAsyncJob.Params.builder()
          .individualId("individual_id")
          .build())
      assertThat(automatedAsyncJob.scheduledAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(automatedAsyncJob.startedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
