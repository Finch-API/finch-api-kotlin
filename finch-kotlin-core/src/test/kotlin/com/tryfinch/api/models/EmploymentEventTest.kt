...
internal class EmploymentEventTest {
    ...
    fun create() {
        ...
        assertThat(employmentEvent.connectionId()).isEqualTo("connection_id")
        assertThat(employmentEvent.entityId()).isEqualTo("entity_id")
        assertThat(employmentEvent.data())
            .isEqualTo(EmploymentEvent.Data.builder().individualId("individual_id").build())
        assertThat(employmentEvent.eventType())
            .isEqualTo(EmploymentEvent.EventType.EMPLOYMENT_CREATED)
    }
