...
class SandboxCompanyUpdateParamsTest {
    ...
    @Test
    fun body() {
      val params = SandboxCompanyUpdateParams.builder()
          .addAccount(SandboxCompanyUpdateParams.Account.builder()
              .accountName("account_name")
              .accountNumber("account_number")
              .accountType(SandboxCompanyUpdateParams.Account.AccountType.CHECKING)
      ...
      assertNotNull(body)
      assertThat(body.accounts()).isEqualTo(listOf(SandboxCompanyUpdateParams.Account.builder()
          .accountName("account_name")
          .accountNumber("account_number")
          .accountType(SandboxCompanyUpdateParams.Account.AccountType.CHECKING)
          .institutionName("institution_name")
          .routingNumber("routing_number")
          .build()))
      assertThat(body.departments()).isEqualTo(listOf(SandboxCompanyUpdateParams.Department.builder()
          .name("name")
          .parent(SandboxCompanyUpdateParams.Department.Parent.builder()
              .name("name")
              .build())
      ...
      assertThat(body.entity()).isEqualTo(SandboxCompanyUpdateParams.Entity.builder()
          .subtype(SandboxCompanyUpdateParams.Entity.Subtype.S_CORPORATION)
          .type(SandboxCompanyUpdateParams.Entity.Type.LLC)
          .build())
      assertThat(body.legalName()).isEqualTo("legal_name")
      assertThat(body.locations()).isEqualTo(listOf(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
    ...
    fun bodyWithoutOptionalFields() {
      ...
      assertNotNull(body)
      assertThat(body.accounts()).isEqualTo(listOf(SandboxCompanyUpdateParams.Account.builder().build()))
      assertThat(body.departments()).isEqualTo(listOf(SandboxCompanyUpdateParams.Department.builder().build()))
      assertThat(body.ein()).isEqualTo("ein")
