...
class JobTest {
    ...
    fun createJob() {
        ...
        assertThat(job.closedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(job.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(job.name()).isEqualTo("string")
