...
class IndividualBenefitTest {
    ...
    fun createIndividualBenefit() {
      val individualBenefit = IndividualBenefit.builder()
          .body(IndividualBenefit.Body.builder()
              .annualMaximum(0L)
              .catchUp(true)
              .companyContribution(BenefitContribution.builder()
                  .amount(0L)
                  .type(BenefitContribution.Type.FIXED)
                  .build())
              .employeeDeduction(BenefitContribution.builder()
                  .amount(0L)
                  .type(BenefitContribution.Type.FIXED)
                  .build())
      ...
      assertThat(individualBenefit.body()).isEqualTo(IndividualBenefit.Body.builder()
          .annualMaximum(0L)
          .catchUp(true)
          .companyContribution(BenefitContribution.builder()
              .amount(0L)
