...
class CompanyUpdateResponseTest {
    ...
    fun createCompanyUpdateResponse() {
        ...
        assertThat(companyUpdateResponse.ein()).isEqualTo("string")
        ...
        assertThat(companyUpdateResponse.legalName()).isEqualTo("string")
        ...
        assertThat(companyUpdateResponse.primaryEmail()).isEqualTo("string")
        assertThat(companyUpdateResponse.primaryPhoneNumber()).isEqualTo("string")
    }
}
