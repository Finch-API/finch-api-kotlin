...
internal class BenefitContributionTest {
    ...
    fun ofFixed() {
        ...
        assertThat(benefitContribution.fixed()).isEqualTo(fixed)
        assertThat(benefitContribution.percent()).isNull()
        assertThat(benefitContribution.tiered()).isNull()
    }
    ...
    fun ofPercent() {
        ...
        assertThat(benefitContribution.fixed()).isNull()
        assertThat(benefitContribution.percent()).isEqualTo(percent)
        assertThat(benefitContribution.tiered()).isNull()
    }
    ...
    fun ofTiered() {
        ...
        assertThat(benefitContribution.fixed()).isNull()
        assertThat(benefitContribution.percent()).isNull()
        assertThat(benefitContribution.tiered()).isEqualTo(tiered)
    }
