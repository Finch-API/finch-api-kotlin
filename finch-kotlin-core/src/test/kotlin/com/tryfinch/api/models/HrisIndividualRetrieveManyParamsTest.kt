...
class HrisIndividualRetrieveManyParamsTest {
    ...
    fun body() {
      ...
      assertNotNull(body)
      assertThat(body.options()).isEqualTo(HrisIndividualRetrieveManyParams.Options.builder()
          .addInclude("string")
          .build())
      assertThat(body.requests()).isEqualTo(listOf(HrisIndividualRetrieveManyParams.Request.builder()
          .individualId("individual_id")
          .build()))
    }
