...
class EmploymentUpdateResponseTest {
    ...
    fun createEmploymentUpdateResponse() {
      val employmentUpdateResponse = EmploymentUpdateResponse.builder()
          .id("id")
          .classCode("class_code")
          .addCustomField(EmploymentUpdateResponse.CustomField.builder()
              .name("name")
              .value(JsonValue.from(mapOf<String, Any>()))
              .build())
          .department(EmploymentUpdateResponse.Department.builder()
              .name("name")
              .build())
          .employment(EmploymentUpdateResponse.Employment.builder()
          ...
          .location(Location.builder()
              ...
              .state("state")
              .build())
          .manager(EmploymentUpdateResponse.Manager.builder()
              .id("id")
              .build())
      ...
      assertThat(employmentUpdateResponse.customFields()).containsExactly(EmploymentUpdateResponse.CustomField.builder()
          .name("name")
          .value(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(employmentUpdateResponse.department()).isEqualTo(EmploymentUpdateResponse.Department.builder()
          .name("name")
          .build())
      assertThat(employmentUpdateResponse.employment()).isEqualTo(EmploymentUpdateResponse.Employment.builder()
          .subtype(EmploymentUpdateResponse.Employment.Subtype.FULL_TIME)
          .type(EmploymentUpdateResponse.Employment.Type.EMPLOYEE)
          .build())
      assertThat(employmentUpdateResponse.employmentStatus()).isEqualTo(EmploymentUpdateResponse.EmploymentStatus.ACTIVE)
      ...
      assertThat(employmentUpdateResponse.income()).isEqualTo(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
          .build())
      assertThat(employmentUpdateResponse.incomeHistory()).containsExactly(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
      ...
      assertThat(employmentUpdateResponse.location()).isEqualTo(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
          ...
          .state("state")
          .build())
      assertThat(employmentUpdateResponse.manager()).isEqualTo(EmploymentUpdateResponse.Manager.builder()
          .id("id")
          .build())
