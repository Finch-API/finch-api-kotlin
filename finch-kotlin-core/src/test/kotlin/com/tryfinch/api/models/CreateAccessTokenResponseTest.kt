...
class CreateAccessTokenResponseTest {
    ...
    fun createCreateAccessTokenResponse() {
      val createAccessTokenResponse = CreateAccessTokenResponse.builder()
      ...
      assertThat(createAccessTokenResponse.clientType()).isEqualTo(CreateAccessTokenResponse.ClientType.PRODUCTION)
      ...
      assertThat(createAccessTokenResponse.connectionType()).isEqualTo(CreateAccessTokenResponse.ConnectionType.PROVIDER)
