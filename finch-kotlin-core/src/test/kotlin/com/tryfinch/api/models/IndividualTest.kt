...
class IndividualTest {
    ...
    fun createIndividual() {
      ...
      assertThat(individual.emails()).containsExactly(Individual.Email.builder()
          .data("data")
          .type(Individual.Email.Type.WORK)
          .build())
      ...
      assertThat(individual.phoneNumbers()).containsExactly(Individual.PhoneNumber.builder()
          .data("data")
          .type(Individual.PhoneNumber.Type.WORK)
          .build())
      assertThat(individual.preferredName()).isEqualTo("preferred_name")
      assertThat(individual.residence()).isEqualTo(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
