...
internal class IndividualTest {
    ...
    fun ofResponseBody() {
        ...
        assertThat(individual.responseBody()).isEqualTo(responseBody)
        assertThat(individual.batchError()).isNull()
    }
    ...
    fun ofBatchError() {
        ...
        assertThat(individual.responseBody()).isNull()
        assertThat(individual.batchError()).isEqualTo(batchError)
    }
