...
internal class EmploymentDataTest {
    ...
    fun ofEmploymentData() {
        ...
        assertThat(employmentData.employmentData()).isEqualTo(employmentData)
        assertThat(employmentData.batchError()).isNull()
    }
    ...
    fun ofBatchError() {
        ...
        assertThat(employmentData.employmentData()).isNull()
        assertThat(employmentData.batchError()).isEqualTo(batchError)
    }
