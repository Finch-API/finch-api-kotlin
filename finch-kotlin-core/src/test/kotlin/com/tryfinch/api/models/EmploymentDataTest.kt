...
class EmploymentDataTest {
    ...
    fun createEmploymentData() {
      val employmentData = EmploymentData.builder()
          .id("id")
      ...
      assertThat(employmentData.customFields()).containsExactly(EmploymentData.CustomField.builder()
          .name("name")
          .value(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(employmentData.department()).isEqualTo(EmploymentData.Department.builder()
          .name("name")
          .build())
      assertThat(employmentData.employment()).isEqualTo(EmploymentData.Employment.builder()
          .subtype(EmploymentData.Employment.Subtype.FULL_TIME)
          .type(EmploymentData.Employment.Type.EMPLOYEE)
          .build())
      assertThat(employmentData.employmentStatus()).isEqualTo(EmploymentData.EmploymentStatus.ACTIVE)
      assertThat(employmentData.endDate()).isEqualTo("end_date")
      assertThat(employmentData.firstName()).isEqualTo("first_name")
      assertThat(employmentData.income()).isEqualTo(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
          .build())
      assertThat(employmentData.incomeHistory()).containsExactly(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
      ...
      assertThat(employmentData.location()).isEqualTo(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
          ...
          .state("state")
          .build())
      assertThat(employmentData.manager()).isEqualTo(EmploymentData.Manager.builder()
          .id("id")
          .build())
