...
class SessionServiceAsyncTest {
    ...
    suspend fun new() {
      ...
      val response = sessionServiceAsync.new(ConnectSessionNewParams.builder()
          .customerId("x")
          .customerName("x")
    ...
    suspend fun reauthenticate() {
      ...
      val response = sessionServiceAsync.reauthenticate(ConnectSessionReauthenticateParams.builder()
