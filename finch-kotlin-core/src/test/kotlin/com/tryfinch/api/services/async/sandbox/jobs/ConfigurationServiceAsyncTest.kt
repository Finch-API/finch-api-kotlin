...
class ConfigurationServiceAsyncTest {
    ...
    suspend fun update() {
      ...
      val sandboxJobConfiguration = configurationServiceAsync.update(SandboxJobConfigurationUpdateParams.builder()
          .sandboxJobConfiguration(SandboxJobConfiguration.builder()
