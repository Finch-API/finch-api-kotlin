...
@NoAutoDetect
class AutomatedListResponse @JsonCreator private constructor(
    @JsonProperty("data") @ExcludeMissing private val data: JsonField<List<AutomatedAsyncJob>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AutomatedAsyncJob>> = data
    ...
    fun validate(): AutomatedListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(automatedListResponse: AutomatedListResponse) =
            apply {
        ...
        fun data(data: JsonField<List<AutomatedAsyncJob>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        fun addData(data: AutomatedAsyncJob) =
            apply {
    ...
    class Meta @JsonCreator private constructor(
        @JsonProperty("quotas") @ExcludeMissing private val quotas: JsonField<Quotas> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
         ...
         * details.
         */
        fun quotas(): Quotas? = quotas.getNullable("quotas")
        ...
        @JsonProperty("quotas")
        @ExcludeMissing
        fun _quotas(): JsonField<Quotas> = quotas
        ...
        class Builder internal constructor() {
             ...
             * details.
             */
            fun quotas(quotas: JsonField<Quotas>) =
                apply {
                    this.quotas = quotas
                }
            ...
            fun build(): Meta =
                Meta(
                  quotas, additionalProperties.toImmutable()
                )
        }
         ...
         */
        @NoAutoDetect
        class Quotas @JsonCreator private constructor(
            @JsonProperty("data_sync_all") @ExcludeMissing private val dataSyncAll: JsonField<DataSyncAll> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

        ) {

            fun dataSyncAll(): DataSyncAll? = dataSyncAll.getNullable("data_sync_all")
            ...
            class Builder internal constructor() {
                ...
                internal fun from(quotas: Quotas) =
                    apply {
                ...
                fun dataSyncAll(dataSyncAll: JsonField<DataSyncAll>) =
                    apply {
                ...
                fun build(): Quotas =
                    Quotas(
                      dataSyncAll, additionalProperties.toImmutable()
                    )
            }

            @NoAutoDetect
            class DataSyncAll @JsonCreator private constructor(
                @JsonProperty("allowed_refreshes") @ExcludeMissing private val allowedRefreshes: JsonField<Long> = JsonMissing.of(),
                @JsonProperty("remaining_refreshes") @ExcludeMissing private val remainingRefreshes: JsonField<Long> = JsonMissing.of(),
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

            ) {

                fun allowedRefreshes(): Long? = allowedRefreshes.getNullable("allowed_refreshes")

                fun remainingRefreshes(): Long? = remainingRefreshes.getNullable("remaining_refreshes")
                ...
                class Builder internal constructor() {
                    ...
                    fun allowedRefreshes(allowedRefreshes: Long) = allowedRefreshes(JsonField.of(allowedRefreshes))

                    fun allowedRefreshes(allowedRefreshes: JsonField<Long>) =
                        apply {
                            this.allowedRefreshes = allowedRefreshes
                        }

                    fun remainingRefreshes(remainingRefreshes: Long) = remainingRefreshes(JsonField.of(remainingRefreshes))

                    fun remainingRefreshes(remainingRefreshes: JsonField<Long>) =
                        apply {
                ...
                override fun toString() = "DataSyncAll{allowedRefreshes=$allowedRefreshes, remainingRefreshes=$remainingRefreshes, additionalProperties=$additionalProperties}"
            }
            ...
            override fun toString() = "Quotas{dataSyncAll=$dataSyncAll, additionalProperties=$additionalProperties}"
        }
    ...
    override fun toString() = "AutomatedListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
