...
@NoAutoDetect
class PayStatementEvent @JsonCreator private constructor(
    ...
    fun validate(): PayStatementEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payStatementEvent: PayStatementEvent) =
            apply {
    ...
    class Data @JsonCreator private constructor(
        ...
        override fun toString() = "Data{individualId=$individualId, paymentId=$paymentId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "PayStatementEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
