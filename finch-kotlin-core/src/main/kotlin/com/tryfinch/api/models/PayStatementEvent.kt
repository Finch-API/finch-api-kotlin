...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payStatementEvent: PayStatementEvent) = apply {
            ...
            entityId = payStatementEvent.entityId
    ...
    override fun toString() =
        "PayStatementEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, entityId=$entityId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
