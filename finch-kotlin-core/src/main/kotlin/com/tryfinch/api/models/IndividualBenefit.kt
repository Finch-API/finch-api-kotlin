...
private constructor(
    ...
    private constructor(
        ...
        fun individualBenefit(): InnerIndividualBenefit? = individualBenefit
         ...
         *     override fun visitIndividualBenefit(individualBenefit: InnerIndividualBenefit): String? = individualBenefit.toString()
         *
         *     // ...
         *
        ...
        private constructor(
            ...
            private constructor(
                ...
                fun fixed(): CompanyContributionFixed? = fixed

                fun percent(): CompanyContributionPercent? = percent

                fun tiered(): CompanyContributionTiered? = tiered
                 ...
                 * import com.tryfinch.api.core.JsonValue
                 *
                 * val result: String? = companyContribution.accept(object : CompanyContribution.Visitor<String?> {
                 *     override fun visitFixed(fixed: CompanyContributionFixed): String? = fixed.toString()
                 *
                 *     // ...
                 *
                 *     override fun unknown(json: JsonValue?): String? {
            ...
            private constructor(
                ...
                fun contributionFixed(): EmployeeDeductionContributionFixed? = contributionFixed

                fun contributionPercent(): EmployeeDeductionContributionPercent? =
                    contributionPercent
                 ...
                 * import com.tryfinch.api.core.JsonValue
                 *
                 * val result: String? = employeeDeduction.accept(object : EmployeeDeduction.Visitor<String?> {
                 *     override fun visitContributionFixed(contributionFixed: EmployeeDeductionContributionFixed): String? = contributionFixed.toString()
                 *
                 *     // ...
                 *
                 *     override fun unknown(json: JsonValue?): String? {
