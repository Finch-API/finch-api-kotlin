...
@NoAutoDetect
class DirectoryEvent @JsonCreator private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DirectoryEvent].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(directoryEvent: DirectoryEvent) =
            apply {
    ...
    override fun toString() = "DirectoryEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
