...
@NoAutoDetect
class DocumentResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(documentResponse: DocumentResponse) =
            apply {
    ...
    override fun toString() = "DocumentResponse{id=$id, individualId=$individualId, type=$type, url=$url, year=$year, additionalProperties=$additionalProperties}"
}
