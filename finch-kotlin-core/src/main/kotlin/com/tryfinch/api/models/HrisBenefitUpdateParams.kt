...
class HrisBenefitUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                  description, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisBenefitUpdateParams: HrisBenefitUpdateParams) =
            apply {
    ...
    override fun toString() = "HrisBenefitUpdateParams{benefitId=$benefitId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
