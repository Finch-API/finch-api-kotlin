...
private constructor(
    ...
    /** A builder for [HrisPayStatementRetrieveManyPageResponse]. */
    class Builder internal constructor() {

        private var responses: JsonField<MutableList<PayStatementResponse>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(
            hrisPayStatementRetrieveManyPageResponse: HrisPayStatementRetrieveManyPageResponse
        ) = apply {
            responses =
                hrisPayStatementRetrieveManyPageResponse.responses.map { it.toMutableList() }
            additionalProperties =
                hrisPayStatementRetrieveManyPageResponse.additionalProperties.toMutableMap()
        }
         ...
         * `List<PayStatementResponse>` value instead. This method is primarily for setting the
        ...
        /**
         * Adds a single [PayStatementResponse] to [responses].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResponse(response: PayStatementResponse) = apply {
            responses =
        ...
        /**
         * Returns an immutable instance of [HrisPayStatementRetrieveManyPageResponse].
         *
    ...
    fun validate(): HrisPayStatementRetrieveManyPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is HrisPayStatementRetrieveManyPageResponse && responses == other.responses && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "HrisPayStatementRetrieveManyPageResponse{responses=$responses, additionalProperties=$additionalProperties}"
}
