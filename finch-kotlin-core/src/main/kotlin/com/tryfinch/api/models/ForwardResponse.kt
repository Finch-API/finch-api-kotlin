...
@JsonDeserialize(builder = ForwardResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): ForwardResponse = apply {
        if (!validated) {
            statusCode()
            data()
            request().validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ForwardResponse &&
    ...
    override fun toString() =
        "ForwardResponse{headers=$headers, statusCode=$statusCode, data=$data, request=$request, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(forwardResponse: ForwardResponse) = apply {
            this.headers = forwardResponse.headers
            this.statusCode = forwardResponse.statusCode
            this.data = forwardResponse.data
            this.request = forwardResponse.request
            additionalProperties(forwardResponse.additionalProperties)
        }
