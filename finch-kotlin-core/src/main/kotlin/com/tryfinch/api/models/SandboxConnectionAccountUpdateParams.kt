 ...
 */
class SandboxConnectionAccountUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("connection_status") @ExcludeMissing private val connectionStatus: JsonField<ConnectionStatusType> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

    ) {

        fun connectionStatus(): ConnectionStatusType? = connectionStatus.getNullable("connection_status")
        ...
        class Builder internal constructor() {
            ...
            fun connectionStatus(connectionStatus: ConnectionStatusType) = connectionStatus(JsonField.of(connectionStatus))

            fun connectionStatus(connectionStatus: JsonField<ConnectionStatusType>) =
                apply {
            ...
            fun build(): Body =
                Body(
                  connectionStatus, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{connectionStatus=$connectionStatus, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sandboxConnectionAccountUpdateParams: SandboxConnectionAccountUpdateParams) =
            apply {
                ...
                additionalQueryParams = sandboxConnectionAccountUpdateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "SandboxConnectionAccountUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
