...
class PayrollPayGroupRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payrollPayGroupRetrieveParams: PayrollPayGroupRetrieveParams) =
            apply {
        ...
        fun payGroupId(payGroupId: String) =
            apply {
    ...
    override fun toString() = "PayrollPayGroupRetrieveParams{payGroupId=$payGroupId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
