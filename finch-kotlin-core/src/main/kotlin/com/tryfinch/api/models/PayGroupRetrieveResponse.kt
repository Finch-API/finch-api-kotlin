...
@NoAutoDetect
class PayGroupRetrieveResponse @JsonCreator private constructor(
    ...
    fun validate(): PayGroupRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payGroupRetrieveResponse: PayGroupRetrieveResponse) =
            apply {
    ...
    override fun toString() = "PayGroupRetrieveResponse{id=$id, individualIds=$individualIds, name=$name, payFrequencies=$payFrequencies, additionalProperties=$additionalProperties}"
}
