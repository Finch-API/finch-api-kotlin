...
@NoAutoDetect
class IndividualUpdateResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(individualUpdateResponse: IndividualUpdateResponse) =
            apply {
    ...
    override fun toString() = "IndividualUpdateResponse{id=$id, dob=$dob, emails=$emails, encryptedSsn=$encryptedSsn, ethnicity=$ethnicity, firstName=$firstName, gender=$gender, lastName=$lastName, middleName=$middleName, phoneNumbers=$phoneNumbers, preferredName=$preferredName, residence=$residence, ssn=$ssn, additionalProperties=$additionalProperties}"
}
