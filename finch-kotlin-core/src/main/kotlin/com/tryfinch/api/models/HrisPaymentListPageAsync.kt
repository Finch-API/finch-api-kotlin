...
class HrisPaymentListPageAsync private constructor(
    ...
    override fun toString() = "HrisPaymentListPageAsync{paymentsService=$paymentsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(paymentsService: PaymentServiceAsync, params: HrisPaymentListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        ...
        @JsonProperty("items")
        fun _items(): JsonField<List<Payment>>? = items
