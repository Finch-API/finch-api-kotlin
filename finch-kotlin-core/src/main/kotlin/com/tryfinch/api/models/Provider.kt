...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            private val _457: JsonField<BenefitSupportType>,
            private val _401k: JsonField<BenefitSupportType>,
            private val _401kRoth: JsonField<BenefitSupportType>,
            private val _401kLoan: JsonField<BenefitSupportType>,
            private val _403b: JsonField<BenefitSupportType>,
            private val _403bRoth: JsonField<BenefitSupportType>,
            private val _457Roth: JsonField<BenefitSupportType>,
            private val s125Medical: JsonField<BenefitSupportType>,
            private val s125Dental: JsonField<BenefitSupportType>,
            private val s125Vision: JsonField<BenefitSupportType>,
            private val hsaPre: JsonField<BenefitSupportType>,
            private val hsaPost: JsonField<BenefitSupportType>,
            private val fsaMedical: JsonField<BenefitSupportType>,
            private val fsaDependentCare: JsonField<BenefitSupportType>,
            private val simpleIra: JsonField<BenefitSupportType>,
            private val simple: JsonField<BenefitSupportType>,
            private val commuter: JsonField<BenefitSupportType>,
            private val customPostTax: JsonField<BenefitSupportType>,
            private val customPreTax: JsonField<BenefitSupportType>,
            private val additionalProperties: Map<String, JsonValue>,
        ) {
            ...
            fun _457(): BenefitSupportType? = _457.getNullable("457")

            fun _401k(): BenefitSupportType? = _401k.getNullable("401k")

            fun _401kRoth(): BenefitSupportType? = _401kRoth.getNullable("401k_roth")

            fun _401kLoan(): BenefitSupportType? = _401kLoan.getNullable("401k_loan")

            fun _403b(): BenefitSupportType? = _403b.getNullable("403b")

            fun _403bRoth(): BenefitSupportType? = _403bRoth.getNullable("403b_roth")

            fun _457Roth(): BenefitSupportType? = _457Roth.getNullable("457_roth")

            fun s125Medical(): BenefitSupportType? = s125Medical.getNullable("s125_medical")

            fun s125Dental(): BenefitSupportType? = s125Dental.getNullable("s125_dental")

            fun s125Vision(): BenefitSupportType? = s125Vision.getNullable("s125_vision")

            fun hsaPre(): BenefitSupportType? = hsaPre.getNullable("hsa_pre")

            fun hsaPost(): BenefitSupportType? = hsaPost.getNullable("hsa_post")

            fun fsaMedical(): BenefitSupportType? = fsaMedical.getNullable("fsa_medical")

            fun fsaDependentCare(): BenefitSupportType? =
                fsaDependentCare.getNullable("fsa_dependent_care")

            fun simpleIra(): BenefitSupportType? = simpleIra.getNullable("simple_ira")

            fun simple(): BenefitSupportType? = simple.getNullable("simple")

            fun commuter(): BenefitSupportType? = commuter.getNullable("commuter")

            fun customPostTax(): BenefitSupportType? = customPostTax.getNullable("custom_post_tax")

            fun customPreTax(): BenefitSupportType? = customPreTax.getNullable("custom_pre_tax")

            @JsonProperty("457") @ExcludeMissing fun __457() = _457

            @JsonProperty("401k") @ExcludeMissing fun __401k() = _401k

            @JsonProperty("401k_roth") @ExcludeMissing fun __401kRoth() = _401kRoth

            @JsonProperty("401k_loan") @ExcludeMissing fun __401kLoan() = _401kLoan

            @JsonProperty("403b") @ExcludeMissing fun __403b() = _403b

            @JsonProperty("403b_roth") @ExcludeMissing fun __403bRoth() = _403bRoth

            @JsonProperty("457_roth") @ExcludeMissing fun __457Roth() = _457Roth
            ...
            @ExcludeMissing
            fun _fsaDependentCare() = fsaDependentCare
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is BenefitsSupport &&
                    this._457 == other._457 &&
                    this._401k == other._401k &&
                    this._401kRoth == other._401kRoth &&
                    this._401kLoan == other._401kLoan &&
                    this._403b == other._403b &&
                    this._403bRoth == other._403bRoth &&
                    this._457Roth == other._457Roth &&
            ...
            override fun toString() =
                "BenefitsSupport{_457=$_457, _401k=$_401k, _401kRoth=$_401kRoth, _401kLoan=$_401kLoan, _403b=$_403b, _403bRoth=$_403bRoth, _457Roth=$_457Roth, s125Medical=$s125Medical, s125Dental=$s125Dental, s125Vision=$s125Vision, hsaPre=$hsaPre, hsaPost=$hsaPost, fsaMedical=$fsaMedical, fsaDependentCare=$fsaDependentCare, simpleIra=$simpleIra, simple=$simple, commuter=$commuter, customPostTax=$customPostTax, customPreTax=$customPreTax, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                private var _457: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _401k: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _401kRoth: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _401kLoan: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _403b: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _403bRoth: JsonField<BenefitSupportType> = JsonMissing.of()
                private var _457Roth: JsonField<BenefitSupportType> = JsonMissing.of()
                private var s125Medical: JsonField<BenefitSupportType> = JsonMissing.of()
                private var s125Dental: JsonField<BenefitSupportType> = JsonMissing.of()
                private var s125Vision: JsonField<BenefitSupportType> = JsonMissing.of()
                private var hsaPre: JsonField<BenefitSupportType> = JsonMissing.of()
                private var hsaPost: JsonField<BenefitSupportType> = JsonMissing.of()
                private var fsaMedical: JsonField<BenefitSupportType> = JsonMissing.of()
                private var fsaDependentCare: JsonField<BenefitSupportType> = JsonMissing.of()
                private var simpleIra: JsonField<BenefitSupportType> = JsonMissing.of()
                private var simple: JsonField<BenefitSupportType> = JsonMissing.of()
                private var commuter: JsonField<BenefitSupportType> = JsonMissing.of()
                private var customPostTax: JsonField<BenefitSupportType> = JsonMissing.of()
                private var customPreTax: JsonField<BenefitSupportType> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                internal fun from(benefitsSupport: BenefitsSupport) = apply {
                    this._457 = benefitsSupport._457
                    this._401k = benefitsSupport._401k
                    this._401kRoth = benefitsSupport._401kRoth
                    this._401kLoan = benefitsSupport._401kLoan
                    this._403b = benefitsSupport._403b
                    this._403bRoth = benefitsSupport._403bRoth
                    this._457Roth = benefitsSupport._457Roth
                ...
                fun _457(_457: BenefitSupportType) = _457(JsonField.of(_457))

                @JsonProperty("457")
                @ExcludeMissing
                fun _457(_457: JsonField<BenefitSupportType>) = apply { this._457 = _457 }

                fun _401k(_401k: BenefitSupportType) = _401k(JsonField.of(_401k))

                @JsonProperty("401k")
                @ExcludeMissing
                fun _401k(_401k: JsonField<BenefitSupportType>) = apply { this._401k = _401k }

                fun _401kRoth(_401kRoth: BenefitSupportType) = _401kRoth(JsonField.of(_401kRoth))

                @JsonProperty("401k_roth")
                @ExcludeMissing
                fun _401kRoth(_401kRoth: JsonField<BenefitSupportType>) = apply {
                    this._401kRoth = _401kRoth
                }

                fun _401kLoan(_401kLoan: BenefitSupportType) = _401kLoan(JsonField.of(_401kLoan))

                @JsonProperty("401k_loan")
                @ExcludeMissing
                fun _401kLoan(_401kLoan: JsonField<BenefitSupportType>) = apply {
                    this._401kLoan = _401kLoan
                }

                fun _403b(_403b: BenefitSupportType) = _403b(JsonField.of(_403b))

                @JsonProperty("403b")
                @ExcludeMissing
                fun _403b(_403b: JsonField<BenefitSupportType>) = apply { this._403b = _403b }

                fun _403bRoth(_403bRoth: BenefitSupportType) = _403bRoth(JsonField.of(_403bRoth))

                @JsonProperty("403b_roth")
                @ExcludeMissing
                fun _403bRoth(_403bRoth: JsonField<BenefitSupportType>) = apply {
                    this._403bRoth = _403bRoth
                }

                fun _457Roth(_457Roth: BenefitSupportType) = _457Roth(JsonField.of(_457Roth))

                @JsonProperty("457_roth")
                @ExcludeMissing
                fun _457Roth(_457Roth: JsonField<BenefitSupportType>) = apply {
                    this._457Roth = _457Roth
                }

                fun s125Medical(s125Medical: BenefitSupportType) =
                    s125Medical(JsonField.of(s125Medical))

                @JsonProperty("s125_medical")
                @ExcludeMissing
                fun s125Medical(s125Medical: JsonField<BenefitSupportType>) = apply {
                    this.s125Medical = s125Medical
                }

                fun s125Dental(s125Dental: BenefitSupportType) =
                    s125Dental(JsonField.of(s125Dental))

                @JsonProperty("s125_dental")
                @ExcludeMissing
                fun s125Dental(s125Dental: JsonField<BenefitSupportType>) = apply {
                    this.s125Dental = s125Dental
                }

                fun s125Vision(s125Vision: BenefitSupportType) =
                    s125Vision(JsonField.of(s125Vision))

                @JsonProperty("s125_vision")
                @ExcludeMissing
                fun s125Vision(s125Vision: JsonField<BenefitSupportType>) = apply {
                    this.s125Vision = s125Vision
                }

                fun hsaPre(hsaPre: BenefitSupportType) = hsaPre(JsonField.of(hsaPre))

                @JsonProperty("hsa_pre")
                @ExcludeMissing
                fun hsaPre(hsaPre: JsonField<BenefitSupportType>) = apply { this.hsaPre = hsaPre }

                fun hsaPost(hsaPost: BenefitSupportType) = hsaPost(JsonField.of(hsaPost))

                @JsonProperty("hsa_post")
                @ExcludeMissing
                fun hsaPost(hsaPost: JsonField<BenefitSupportType>) = apply {
                    this.hsaPost = hsaPost
                }

                fun fsaMedical(fsaMedical: BenefitSupportType) =
                    fsaMedical(JsonField.of(fsaMedical))

                @JsonProperty("fsa_medical")
                @ExcludeMissing
                fun fsaMedical(fsaMedical: JsonField<BenefitSupportType>) = apply {
                    this.fsaMedical = fsaMedical
                }

                fun fsaDependentCare(fsaDependentCare: BenefitSupportType) =
                    fsaDependentCare(JsonField.of(fsaDependentCare))

                @JsonProperty("fsa_dependent_care")
                @ExcludeMissing
                fun fsaDependentCare(fsaDependentCare: JsonField<BenefitSupportType>) = apply {
                    this.fsaDependentCare = fsaDependentCare
                }

                fun simpleIra(simpleIra: BenefitSupportType) = simpleIra(JsonField.of(simpleIra))

                @JsonProperty("simple_ira")
                @ExcludeMissing
                fun simpleIra(simpleIra: JsonField<BenefitSupportType>) = apply {
                    this.simpleIra = simpleIra
                }

                fun simple(simple: BenefitSupportType) = simple(JsonField.of(simple))

                @JsonProperty("simple")
                @ExcludeMissing
                fun simple(simple: JsonField<BenefitSupportType>) = apply { this.simple = simple }

                fun commuter(commuter: BenefitSupportType) = commuter(JsonField.of(commuter))

                @JsonProperty("commuter")
                @ExcludeMissing
                fun commuter(commuter: JsonField<BenefitSupportType>) = apply {
                    this.commuter = commuter
                }

                fun customPostTax(customPostTax: BenefitSupportType) =
                    customPostTax(JsonField.of(customPostTax))

                @JsonProperty("custom_post_tax")
                @ExcludeMissing
                fun customPostTax(customPostTax: JsonField<BenefitSupportType>) = apply {
                    this.customPostTax = customPostTax
                }

                fun customPreTax(customPreTax: BenefitSupportType) =
                    customPreTax(JsonField.of(customPreTax))

                @JsonProperty("custom_pre_tax")
                @ExcludeMissing
                fun customPreTax(customPreTax: JsonField<BenefitSupportType>) = apply {
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    private val department: JsonValue,
                    ...
                    class Builder {
                        ...
                        private var department: JsonValue = JsonMissing.of()
                        ...
                        @ExcludeMissing
                        fun department(department: JsonValue) = apply {
