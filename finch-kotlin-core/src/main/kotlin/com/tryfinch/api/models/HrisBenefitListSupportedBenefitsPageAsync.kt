...
class HrisBenefitListSupportedBenefitsPageAsync private constructor(
    ...
    override fun toString() = "HrisBenefitListSupportedBenefitsPageAsync{benefitsService=$benefitsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(benefitsService: BenefitServiceAsync, params: HrisBenefitListSupportedBenefitsParams, response: Response) =
