...
@NoAutoDetect
class CompanyEvent @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(companyEvent: CompanyEvent) =
            apply {
    ...
    override fun toString() = "CompanyEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
