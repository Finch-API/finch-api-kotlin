...
class BenefitFrequency @JsonCreator private constructor(
    ...
    /**
     * An enum containing [BenefitFrequency]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [BenefitFrequency] can contain an unknown value in a couple of
     * cases:
     *
    ...
    enum class Value {
        ...
        MONTHLY,
        /**
         * An enum member indicating that [BenefitFrequency] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
