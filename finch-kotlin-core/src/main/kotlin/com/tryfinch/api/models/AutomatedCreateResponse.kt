...
private constructor(
     ...
     */
    fun jobId(): String? = jobId.getNullable("job_id")
     ...
     *   server responded with an unexpected value).
     */
    fun jobUrl(): String? = jobUrl.getNullable("job_url")
     ...
     *   server responded with an unexpected value).
     */
    fun retryAt(): String? = retryAt.getNullable("retry_at")
    ...
    internal fun validity(): Int =
        (if (allowedRefreshes.asKnown() == null) 0 else 1) +
            ...
            (if (jobUrl.asKnown() == null) 0 else 1) +
            (if (retryAt.asKnown() == null) 0 else 1)
