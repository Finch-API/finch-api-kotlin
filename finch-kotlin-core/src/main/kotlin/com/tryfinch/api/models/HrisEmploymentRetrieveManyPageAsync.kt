...
class HrisEmploymentRetrieveManyPageAsync private constructor(
    ...
    override fun toString() = "HrisEmploymentRetrieveManyPageAsync{employmentsService=$employmentsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(employmentsService: EmploymentServiceAsync, params: HrisEmploymentRetrieveManyParams, response: Response) =
