...
constructor(
    ...
    fun headers(): JsonValue? = headers

    fun params(): JsonValue? = params

    internal fun getBody(): ClientForwardBody {
        return ClientForwardBody(
            method,
            route,
            data,
            headers,
    ...
    @JsonDeserialize(builder = ClientForwardBody.Builder::class)
    @NoAutoDetect
    class ClientForwardBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ClientForwardBody &&
        ...
        override fun toString() =
            "ClientForwardBody{method=$method, route=$route, data=$data, headers=$headers, params=$params, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(clientForwardBody: ClientForwardBody) = apply {
                this.method = clientForwardBody.method
                this.route = clientForwardBody.route
                this.data = clientForwardBody.data
                this.headers = clientForwardBody.headers
                this.params = clientForwardBody.params
                additionalProperties(clientForwardBody.additionalProperties)
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClientForwardParams &&
            this.method == other.method &&
            this.route == other.route &&
            this.data == other.data &&
            this.headers == other.headers &&
    ...
    override fun toString() =
        "ClientForwardParams{method=$method, route=$route, data=$data, headers=$headers, params=$params, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(clientForwardParams: ClientForwardParams) = apply {
            this.method = clientForwardParams.method
            this.route = clientForwardParams.route
            this.data = clientForwardParams.data
            this.headers = clientForwardParams.headers
            this.params = clientForwardParams.params
            additionalQueryParams(clientForwardParams.additionalQueryParams)
            additionalHeaders(clientForwardParams.additionalHeaders)
            additionalBodyProperties(clientForwardParams.additionalBodyProperties)
        }
