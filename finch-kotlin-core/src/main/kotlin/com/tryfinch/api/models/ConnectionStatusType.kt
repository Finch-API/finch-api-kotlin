...
class ConnectionStatusType @JsonCreator private constructor(
    ...
    /**
     * An enum containing [ConnectionStatusType]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [ConnectionStatusType] can contain an unknown value in a couple
     * of cases:
     *
    ...
    enum class Value {
        ...
        REAUTH,
        /**
         * An enum member indicating that [ConnectionStatusType] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
