...
class HrisBenefitIndividualUnenrollManyParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                  (individualIds ?: JsonMissing.of()).map { it.toImmutable() }, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{individualIds=$individualIds, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisBenefitIndividualUnenrollManyParams: HrisBenefitIndividualUnenrollManyParams) =
            apply {
                benefitId = hrisBenefitIndividualUnenrollManyParams.benefitId
                body = hrisBenefitIndividualUnenrollManyParams.body.toBuilder()
                additionalHeaders = hrisBenefitIndividualUnenrollManyParams.additionalHeaders.toBuilder()
                additionalQueryParams = hrisBenefitIndividualUnenrollManyParams.additionalQueryParams.toBuilder()
            }

        fun benefitId(benefitId: String) =
            apply {
    ...
    override fun toString() = "HrisBenefitIndividualUnenrollManyParams{benefitId=$benefitId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
