...
class HrisBenefitIndividualRetrieveManyBenefitsParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.individualIds?.let {
          queryParams.put(
            "individual_ids", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisBenefitIndividualRetrieveManyBenefitsParams: HrisBenefitIndividualRetrieveManyBenefitsParams) =
            apply {
                ...
                additionalHeaders = hrisBenefitIndividualRetrieveManyBenefitsParams.additionalHeaders.toBuilder()
                additionalQueryParams = hrisBenefitIndividualRetrieveManyBenefitsParams.additionalQueryParams.toBuilder()
            }
         ...
         * defaults to all individuals
         */
        fun individualIds(individualIds: String?) =
            apply {
    ...
    override fun toString() = "HrisBenefitIndividualRetrieveManyBenefitsParams{benefitId=$benefitId, individualIds=$individualIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
