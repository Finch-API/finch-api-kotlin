...
private constructor(
    ...
    /**
     * The entity IDs to create the rule for. Provide exactly one entity ID per request; a maximum
     * of one is accepted.
     */
     ...
     *   server responded with an unexpected value).
     */
    fun conditions(): List<Condition>? = body.conditions()
     ...
     *   server responded with an unexpected value).
     */
    fun effectiveEndDate(): String? = body.effectiveEndDate()
     ...
     *   server responded with an unexpected value).
     */
    fun effectiveStartDate(): String? = body.effectiveStartDate()
    ...
    class Builder internal constructor() {
        ...
        /**
         * The entity IDs to create the rule for. Provide exactly one entity ID per request; a
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CreateRuleRequest &&
