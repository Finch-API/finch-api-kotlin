...
private constructor(
    ...
    private constructor(
        ...
        fun hiringManagers(): List<HiringManager>? = hiringManagers.getNullable("hiring_managers")

        fun recruiters(): List<Recruiter>? = recruiters.getNullable("recruiters")
        ...
        fun validate(): HiringTeam = apply {
            if (!validated) {
                hiringManagers()?.forEach { it.validate() }
                recruiters()?.forEach { it.validate() }
                validated = true
            }
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            val ON_HOLD = Status(JsonField.of("on_hold"))
