...
@NoAutoDetect
class IndividualResponse @JsonCreator private constructor(
    @JsonProperty("body") @ExcludeMissing private val body: JsonField<Individual> = JsonMissing.of(),
    ...
    @JsonProperty("body")
    @ExcludeMissing
    fun _body(): JsonField<Individual> = body
    ...
    fun validate(): IndividualResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(individualResponse: IndividualResponse) =
            apply {
        ...
        fun body(body: JsonField<Individual>) =
            apply {
                this.body = body
            }
    ...
    override fun toString() = "IndividualResponse{body=$body, code=$code, individualId=$individualId, additionalProperties=$additionalProperties}"
}
