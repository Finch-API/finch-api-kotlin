...
class HrisIndividualRetrieveManyParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{options=$options, requests=$requests, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisIndividualRetrieveManyParams: HrisIndividualRetrieveManyParams) =
            apply {
                ...
                additionalQueryParams = hrisIndividualRetrieveManyParams.additionalQueryParams.toBuilder()
            }
    ...
    class Options @JsonCreator private constructor(
        @JsonProperty("include") @ExcludeMissing private val include: JsonField<List<String>> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        @ExcludeMissing
        fun _include(): JsonField<List<String>> = include
        ...
        class Builder internal constructor() {
            ...
            fun include(include: JsonField<List<String>>) =
                apply {
            ...
            fun addInclude(include: String) =
                apply {
                    this.include = (this.include ?: JsonField.of(mutableListOf())).also {
            ...
            fun build(): Options =
                Options(
                  (include ?: JsonMissing.of()).map { it.toImmutable() }, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Options{include=$include, additionalProperties=$additionalProperties}"
    }
    ...
    class Request @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Request =
                Request(
                  individualId, additionalProperties.toImmutable()
                )
        }
    ...
    override fun toString() = "HrisIndividualRetrieveManyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
