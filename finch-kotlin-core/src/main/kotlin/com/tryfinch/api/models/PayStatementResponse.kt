...
@NoAutoDetect
class PayStatementResponse @JsonCreator private constructor(
    @JsonProperty("body") @ExcludeMissing private val body: JsonField<PayStatementResponseBody> = JsonMissing.of(),
    ...
    @JsonProperty("body")
    @ExcludeMissing
    fun _body(): JsonField<PayStatementResponseBody> = body
    ...
    fun validate(): PayStatementResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payStatementResponse: PayStatementResponse) =
            apply {
        ...
        fun body(body: JsonField<PayStatementResponseBody>) =
            apply {
                this.body = body
            }
    ...
    override fun toString() = "PayStatementResponse{body=$body, code=$code, paymentId=$paymentId, additionalProperties=$additionalProperties}"
}
