...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [body] with `PayStatementResponseBody.ofUnionMember0(unionMember0)`.
         */
        fun body(unionMember0: PayStatementResponseBody.UnionMember0) =
            body(PayStatementResponseBody.ofUnionMember0(unionMember0))

        /** Alias for calling [body] with `PayStatementResponseBody.ofBatchError(batchError)`. */
        fun body(batchError: PayStatementResponseBody.BatchError) =
            body(PayStatementResponseBody.ofBatchError(batchError))

        /**
         * Alias for calling [body] with `PayStatementResponseBody.ofUnionMember2(unionMember2)`.
         */
        fun body(unionMember2: PayStatementResponseBody.UnionMember2) =
            body(PayStatementResponseBody.ofUnionMember2(unionMember2))
