...
@NoAutoDetect
class OperationSupportMatrix @JsonCreator private constructor(
    @JsonProperty("create") @ExcludeMissing private val create: JsonField<OperationSupport> = JsonMissing.of(),
    @JsonProperty("delete") @ExcludeMissing private val delete: JsonField<OperationSupport> = JsonMissing.of(),
    @JsonProperty("read") @ExcludeMissing private val read: JsonField<OperationSupport> = JsonMissing.of(),
    @JsonProperty("update") @ExcludeMissing private val update: JsonField<OperationSupport> = JsonMissing.of(),
    ...
    @JsonProperty("create")
    @ExcludeMissing
    fun _create(): JsonField<OperationSupport> = create
    ...
    @JsonProperty("delete")
    @ExcludeMissing
    fun _delete(): JsonField<OperationSupport> = delete
    ...
    @JsonProperty("read")
    @ExcludeMissing
    fun _read(): JsonField<OperationSupport> = read
    ...
    @JsonProperty("update")
    @ExcludeMissing
    fun _update(): JsonField<OperationSupport> = update
    ...
    fun validate(): OperationSupportMatrix =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(operationSupportMatrix: OperationSupportMatrix) =
            apply {
         ...
         *   available to the client and not to Finch
         */
        fun create(create: JsonField<OperationSupport>) =
            apply {
                this.create = create
            }
         ...
         *   available to the client and not to Finch
         */
        fun delete(delete: JsonField<OperationSupport>) =
            apply {
                this.delete = delete
            }
         ...
         *   available to the client and not to Finch
         */
        fun read(read: JsonField<OperationSupport>) =
            apply {
                this.read = read
            }
         ...
         *   available to the client and not to Finch
         */
        fun update(update: JsonField<OperationSupport>) =
            apply {
                this.update = update
            }
    ...
    override fun toString() = "OperationSupportMatrix{create=$create, delete=$delete, read=$read, update=$update, additionalProperties=$additionalProperties}"
}
