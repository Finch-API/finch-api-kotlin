...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun effectiveEndDate(): String? = effectiveEndDate.getNullable("effective_end_date")
     ...
     *   server responded with an unexpected value).
     */
    fun effectiveStartDate(): String? = effectiveStartDate.getNullable("effective_start_date")
     ...
     *   server responded with an unexpected value).
     */
    fun entityType(): EntityType? = entityType.getNullable("entity_type")
    ...
    /** A builder for [RuleCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(ruleCreateResponse: RuleCreateResponse) = apply {
            id = ruleCreateResponse.id
            attributes = ruleCreateResponse.attributes
            conditions = ruleCreateResponse.conditions.map { it.toMutableList() }
            createdAt = ruleCreateResponse.createdAt
            effectiveEndDate = ruleCreateResponse.effectiveEndDate
            effectiveStartDate = ruleCreateResponse.effectiveStartDate
            entityType = ruleCreateResponse.entityType
            priority = ruleCreateResponse.priority
            updatedAt = ruleCreateResponse.updatedAt
            additionalProperties = ruleCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RuleCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RuleCreateResponse =
            RuleCreateResponse(
                id,
                attributes,
    ...
    fun validate(): RuleCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown() == null) 0 else 1) +
            ...
            (if (effectiveEndDate.asKnown() == null) 0 else 1) +
            (if (effectiveStartDate.asKnown() == null) 0 else 1) +
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun operator(): Operator? = operator.getNullable("operator")
    ...
    class EntityType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val PAY_STATEMENT_ITEM = of("pay_statement_item")
    ...
    override fun toString() =
        "RuleCreateResponse{id=$id, attributes=$attributes, conditions=$conditions, createdAt=$createdAt, effectiveEndDate=$effectiveEndDate, effectiveStartDate=$effectiveStartDate, entityType=$entityType, priority=$priority, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
