...
@NoAutoDetect
class PaymentCreateResponse @JsonCreator private constructor(
    ...
    override fun toString() = "PaymentCreateResponse{payDate=$payDate, paymentId=$paymentId, additionalProperties=$additionalProperties}"
}
