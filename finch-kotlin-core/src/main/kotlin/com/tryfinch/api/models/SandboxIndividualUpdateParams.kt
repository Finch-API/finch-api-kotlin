...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun maritalStatus(): MaritalStatus? = body.maritalStatus()
     ...
     */
    fun _maritalStatus(): JsonField<MaritalStatus> = body._maritalStatus()
    ...
    class Builder internal constructor() {
         ...
         * workflows.
         */
        fun maritalStatus(maritalStatus: MaritalStatus?) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var maritalStatus: JsonField<MaritalStatus> = JsonMissing.of()
            ...
            internal fun from(individualWithoutId: IndividualWithoutId) = apply {
                ...
                maritalStatus = individualWithoutId.maritalStatus
        ...
        override fun toString() =
            "IndividualWithoutId{dob=$dob, emails=$emails, encryptedSsn=$encryptedSsn, ethnicity=$ethnicity, firstName=$firstName, gender=$gender, lastName=$lastName, maritalStatus=$maritalStatus, middleName=$middleName, phoneNumbers=$phoneNumbers, preferredName=$preferredName, residence=$residence, ssn=$ssn, additionalProperties=$additionalProperties}"
    }
