...
class HrisDirectoryListIndividualsPage private constructor(
    ...
    override fun toString() = "HrisDirectoryListIndividualsPage{directoryService=$directoryService, params=$params, response=$response}"
