...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ruleUpdateResponse: RuleUpdateResponse) = apply {
            ...
            conditions = ruleUpdateResponse.conditions.map { it.toMutableList() }
            createdAt = ruleUpdateResponse.createdAt
            effectiveEndDate = ruleUpdateResponse.effectiveEndDate
            effectiveStartDate = ruleUpdateResponse.effectiveStartDate
            entityType = ruleUpdateResponse.entityType
            priority = ruleUpdateResponse.priority
            updatedAt = ruleUpdateResponse.updatedAt
    ...
    override fun toString() =
        "RuleUpdateResponse{id=$id, attributes=$attributes, conditions=$conditions, createdAt=$createdAt, effectiveEndDate=$effectiveEndDate, effectiveStartDate=$effectiveStartDate, entityType=$entityType, priority=$priority, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
