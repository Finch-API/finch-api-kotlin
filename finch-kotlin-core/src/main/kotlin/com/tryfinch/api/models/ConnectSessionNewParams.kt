...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun recordkeeping(): Recordkeeping? = body.recordkeeping()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun recordkeeping(): Recordkeeping? = recordkeeping.getNullable("recordkeeping")
        ...
        internal fun validity(): Int =
            (if (customerId.asKnown() == null) 0 else 1) +
                ...
                (recordkeeping.asKnown()?.validity() ?: 0) +
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (recordkeeper.asKnown()?.validity() ?: 0) + (if (planId.asKnown() == null) 0 else 1)
