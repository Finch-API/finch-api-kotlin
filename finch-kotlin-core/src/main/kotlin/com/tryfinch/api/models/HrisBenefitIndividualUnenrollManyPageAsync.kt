...
class HrisBenefitIndividualUnenrollManyPageAsync private constructor(
    ...
    override fun toString() = "HrisBenefitIndividualUnenrollManyPageAsync{individualsService=$individualsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(individualsService: IndividualServiceAsync, params: HrisBenefitIndividualUnenrollManyParams, response: Response) =
