...
@NoAutoDetect
class RequestForwardingForwardResponse @JsonCreator private constructor(
    ...
    @JsonProperty("statusCode") @ExcludeMissing private val statusCode: JsonField<Long> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _headers(): JsonValue = headers
    ...
    fun validate(): RequestForwardingForwardResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(requestForwardingForwardResponse: RequestForwardingForwardResponse) =
            apply {
                ...
                additionalProperties = requestForwardingForwardResponse.additionalProperties.toMutableMap()
            }
    ...
    class Request @JsonCreator private constructor(
        @JsonProperty("data") @ExcludeMissing private val data: JsonField<String> = JsonMissing.of(),
        @JsonProperty("headers") @ExcludeMissing private val headers: JsonValue = JsonMissing.of(),
        @JsonProperty("method") @ExcludeMissing private val method: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("route")
        @ExcludeMissing
        fun _route(): JsonField<String> = route
        ...
        class Builder internal constructor() {
            ...
            /** The URL route path that was specified for the forwarded request. */
            fun route(route: JsonField<String>) =
                apply {
                    this.route = route
                }
        ...
        override fun toString() = "Request{data=$data, headers=$headers, method=$method, params=$params, route=$route, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "RequestForwardingForwardResponse{data=$data, headers=$headers, request=$request, statusCode=$statusCode, additionalProperties=$additionalProperties}"
}
