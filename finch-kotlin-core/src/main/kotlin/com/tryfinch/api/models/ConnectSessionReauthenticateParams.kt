...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(connectionId, minutesToExpire, products, redirectUri, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
