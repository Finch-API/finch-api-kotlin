...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SessionReauthenticateResponse && this.sessionId == other.sessionId && this.connectUrl == other.connectUrl && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
