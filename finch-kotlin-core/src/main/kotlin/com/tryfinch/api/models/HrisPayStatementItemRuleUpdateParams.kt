...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = hrisPayStatementItemRuleUpdateParams.optionalProperty().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        fun none(): HrisPayStatementItemRuleUpdateParams = builder().build()
