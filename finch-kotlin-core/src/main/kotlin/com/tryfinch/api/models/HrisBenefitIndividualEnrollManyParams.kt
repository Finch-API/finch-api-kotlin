...
private constructor(
    ...
    companion object {
        ...
        fun none(): HrisBenefitIndividualEnrollManyParams = builder().build()
    ...
    fun _body(): List<Individual>? = individuals
    ...
    private constructor(
        ...
        private constructor(
             ...
             */
            fun annualContributionLimit(): AnnualContributionLimit? =
                annualContributionLimit.getNullable("annual_contribution_limit")
            ...
            fun validate(): Configuration = apply {
                ...
                annualContributionLimit()?.validate()
                annualMaximum()
                catchUp()
             ...
             */
            internal fun validity(): Int =
                (annualContributionLimit.asKnown()?.validity() ?: 0) +
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    fun of(value: String) = AnnualContributionLimit(JsonField.of(value))
                }
