...
private constructor(
    ...
    /** A builder for [RegisterCompanyBenefitResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(registerCompanyBenefitResponse: RegisterCompanyBenefitResponse) = apply {
            benefitId = registerCompanyBenefitResponse.benefitId
            jobId = registerCompanyBenefitResponse.jobId
            additionalProperties =
                registerCompanyBenefitResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegisterCompanyBenefitResponse].
         *
         ...
         */
        fun build(): RegisterCompanyBenefitResponse =
            RegisterCompanyBenefitResponse(
     ...
     *   type.
     */
    fun validate(): RegisterCompanyBenefitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RegisterCompanyBenefitResponse &&
    ...
    override fun toString() =
        "RegisterCompanyBenefitResponse{benefitId=$benefitId, jobId=$jobId, additionalProperties=$additionalProperties}"
}
