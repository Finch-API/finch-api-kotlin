...
class W42005 @JsonCreator private constructor(
    ...
    class Data @JsonCreator private constructor(
        ...
        fun additionalWithholding(): Long? = additionalWithholding.getNullable("additional_withholding")
        ...
        fun totalNumberOfAllowances(): Long? = totalNumberOfAllowances.getNullable("total_number_of_allowances")
        ...
        class FilingStatus @JsonCreator private constructor(
            ...
            companion object {
                ...
                val MARRIED_BUT_WITHHOLD_AT_HIGHER_SINGLE_RATE = of("married_but_withhold_at_higher_single_rate")
