...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(employmentEvent: EmploymentEvent) = apply {
            this.connectionId = employmentEvent.connectionId
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && this.individualId == other.individualId && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            val EMPLOYMENT_CREATED = EventType(JsonField.of("employment.created"))

            val EMPLOYMENT_UPDATED = EventType(JsonField.of("employment.updated"))

            val EMPLOYMENT_DELETED = EventType(JsonField.of("employment.deleted"))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EmploymentEvent && this.connectionId == other.connectionId && this.companyId == other.companyId && this.accountId == other.accountId && this.eventType == other.eventType && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
