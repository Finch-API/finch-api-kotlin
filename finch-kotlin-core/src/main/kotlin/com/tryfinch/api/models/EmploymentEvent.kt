...
@NoAutoDetect
class EmploymentEvent @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(employmentEvent: EmploymentEvent) =
            apply {
    ...
    class Data @JsonCreator private constructor(
        ...
        override fun toString() = "Data{individualId=$individualId, additionalProperties=$additionalProperties}"
    }
    ...
    class EventType @JsonCreator private constructor(
        ...
        companion object {
            ...
            val EMPLOYMENT_CREATED = of("employment.created")

            val EMPLOYMENT_UPDATED = of("employment.updated")

            val EMPLOYMENT_DELETED = of("employment.deleted")
    ...
    override fun toString() = "EmploymentEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
