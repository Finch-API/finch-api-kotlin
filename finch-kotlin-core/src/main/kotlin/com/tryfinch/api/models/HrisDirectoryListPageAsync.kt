...
class HrisDirectoryListPageAsync private constructor(
    ...
    override fun toString() = "HrisDirectoryListPageAsync{directoryService=$directoryService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(directoryService: DirectoryServiceAsync, params: HrisDirectoryListParams, response: Response) =
