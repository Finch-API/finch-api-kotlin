 ...
 * supports Benefits.
 */
class HrisPayStatementRetrieveManyPageAsync private constructor(
    ...
    override fun toString() = "HrisPayStatementRetrieveManyPageAsync{payStatementsService=$payStatementsService, params=$params, response=$response}"
    ...
    suspend fun getNextPage(): HrisPayStatementRetrieveManyPageAsync? {
      return getNextPageParams()?.let {
          payStatementsService.retrieveMany(it)
      }
    }
    ...
    companion object {
        ...
        fun of(payStatementsService: PayStatementServiceAsync, params: HrisPayStatementRetrieveManyParams, response: Response) =
