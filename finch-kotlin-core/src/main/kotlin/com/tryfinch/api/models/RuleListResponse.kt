...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RuleListResponse]. */
        fun builder() = Builder()
    }

    /** A builder for [RuleListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(ruleListResponse: RuleListResponse) = apply {
            id = ruleListResponse.id
            attributes = ruleListResponse.attributes
            conditions = ruleListResponse.conditions.map { it.toMutableList() }
            createdAt = ruleListResponse.createdAt
            effectiveEndDate = ruleListResponse.effectiveEndDate
            effectiveStartDate = ruleListResponse.effectiveStartDate
            entityType = ruleListResponse.entityType
            priority = ruleListResponse.priority
            updatedAt = ruleListResponse.updatedAt
            additionalProperties = ruleListResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): RuleListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "RuleListResponse{id=$id, attributes=$attributes, conditions=$conditions, createdAt=$createdAt, effectiveEndDate=$effectiveEndDate, effectiveStartDate=$effectiveStartDate, entityType=$entityType, priority=$priority, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
