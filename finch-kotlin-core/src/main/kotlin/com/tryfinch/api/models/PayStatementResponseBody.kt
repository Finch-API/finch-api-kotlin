        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (earnings.asKnown()?.sumOf { (it?.validity() ?: 0).toInt() } ?: 0) +
                    ...
                    (employerContributions.asKnown()?.sumOf { (it?.validity() ?: 0).toInt() }
                        ?: 0) +
    ...
    private constructor(
        ...
        class Code @JsonCreator private constructor(private val value: JsonField<Double>) : Enum {
            ...
            companion object {
                ...
                fun of(value: Double) = Code(JsonField.of(value))
            }
        ...
        class FinchCode @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val DATA_SYNC_IN_PROGRESS = of("data_sync_in_progress")

                fun of(value: String) = FinchCode(JsonField.of(value))
            }
        ...
        class Message @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                fun of(value: String) = Message(JsonField.of(value))
            }
