...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun authenticationMethods(): List<AuthenticationMethodDetail>? =
     ...
     *   server responded with an unexpected value).
     */
    fun entityIds(): List<String>? = entityIds.getNullable("entity_ids")
     ...
     *   server responded with an unexpected value).
     */
    fun entityMode(): EntityMode? = entityMode.getNullable("entity_mode")
    ...
    fun payrollProviderId(): String? = payrollProviderId.getNullable("payroll_provider_id")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun lastSuccessfulSync(): LastSuccessfulSync? =
        ...
        internal fun validity(): Int =
            (status.asKnown()?.validity() ?: 0) +
                (lastSuccessfulSync.asKnown()?.validity() ?: 0) +
        ...
        private constructor(
            ...
            companion object {
                ...
                fun ofString(string: String) = LastSuccessfulSync(string = string)
            }
    ...
    class EntityMode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            fun of(value: String) = EntityMode(JsonField.of(value))
        }
