...
@NoAutoDetect
class Introspection @JsonCreator private constructor(
    ...
    @JsonProperty("client_type") @ExcludeMissing private val clientType: JsonField<ClientType> = JsonMissing.of(),
    ...
    @JsonProperty("connection_status") @ExcludeMissing private val connectionStatus: JsonField<ConnectionStatus> = JsonMissing.of(),
    @JsonProperty("connection_type") @ExcludeMissing private val connectionType: JsonField<ConnectionType> = JsonMissing.of(),
    ...
    @JsonProperty("payroll_provider_id") @ExcludeMissing private val payrollProviderId: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("username") @ExcludeMissing private val username: JsonField<String> = JsonMissing.of(),
    ...
    fun authenticationMethods(): List<AuthenticationMethod> = authenticationMethods.getRequired("authentication_methods")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(introspection: Introspection) =
            apply {
        ...
        /** The type of application associated with a token. */
        fun clientType(clientType: JsonField<ClientType>) =
            apply {
        ...
        fun connectionStatus(connectionStatus: ConnectionStatus) = connectionStatus(JsonField.of(connectionStatus))

        fun connectionStatus(connectionStatus: JsonField<ConnectionStatus>) =
            apply {
         ...
         * - `finch` - finch-generated data.
         */
        fun connectionType(connectionType: ConnectionType) = connectionType(JsonField.of(connectionType))
         ...
         * - `finch` - finch-generated data.
         */
        fun connectionType(connectionType: JsonField<ConnectionType>) =
            apply {
         ...
         */
        @Deprecated("deprecated")
        fun payrollProviderId(payrollProviderId: String) = payrollProviderId(JsonField.of(payrollProviderId))
         ...
         */
        @Deprecated("deprecated")
        fun payrollProviderId(payrollProviderId: JsonField<String>) =
            apply {
    ...
    class AuthenticationMethod @JsonCreator private constructor(
        ...
        fun connectionStatus(): ConnectionStatus? = connectionStatus.getNullable("connection_status")
        ...
        @NoAutoDetect
        class ConnectionStatus @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(connectionStatus: ConnectionStatus) =
                    apply {
            ...
            override fun toString() = "ConnectionStatus{message=$message, status=$status, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() = "AuthenticationMethod{connectionStatus=$connectionStatus, products=$products, type=$type, additionalProperties=$additionalProperties}"
    }

    /** The type of application associated with a token. */
    class ClientType @JsonCreator private constructor(
        private val value: JsonField<String>,
     ...
     * - `finch` - finch-generated data.
     */
    class ConnectionType @JsonCreator private constructor(
        private val value: JsonField<String>,
