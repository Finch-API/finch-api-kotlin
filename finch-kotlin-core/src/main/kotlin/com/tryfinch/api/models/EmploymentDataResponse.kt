...
@NoAutoDetect
class EmploymentDataResponse @JsonCreator private constructor(
    @JsonProperty("body") @ExcludeMissing private val body: JsonField<EmploymentData> = JsonMissing.of(),
    ...
    @JsonProperty("body")
    @ExcludeMissing
    fun _body(): JsonField<EmploymentData> = body
    ...
    fun validate(): EmploymentDataResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(employmentDataResponse: EmploymentDataResponse) =
            apply {
        ...
        fun body(body: JsonField<EmploymentData>) =
            apply {
                this.body = body
            }
    ...
    override fun toString() = "EmploymentDataResponse{body=$body, code=$code, individualId=$individualId, additionalProperties=$additionalProperties}"
}
