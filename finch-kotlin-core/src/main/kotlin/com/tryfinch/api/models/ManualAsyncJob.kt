...
@NoAutoDetect
class ManualAsyncJob @JsonCreator private constructor(
    @JsonProperty("body") @ExcludeMissing private val body: JsonField<List<JsonValue>> = JsonMissing.of(),
    ...
    @JsonProperty("body")
    @ExcludeMissing
    fun _body(): JsonField<List<JsonValue>> = body
    ...
    class Builder internal constructor() {
        ...
        internal fun from(manualAsyncJob: ManualAsyncJob) =
            apply {
        ...
        /** Specific information about the job, such as individual statuses for batch jobs. */
        fun body(body: JsonField<List<JsonValue>>) =
            apply {
                this.body = body.map { it.toMutableList() }
            }

        /** Specific information about the job, such as individual statuses for batch jobs. */
        fun addBody(body: JsonValue) =
            apply {
                this.body = (this.body ?: JsonField.of(mutableListOf())).also {
    ...
    override fun toString() = "ManualAsyncJob{body=$body, jobId=$jobId, status=$status, additionalProperties=$additionalProperties}"
}
