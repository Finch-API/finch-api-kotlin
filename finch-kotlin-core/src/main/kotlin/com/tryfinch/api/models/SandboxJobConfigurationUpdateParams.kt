...
class SandboxJobConfigurationUpdateParams private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = sandboxJobConfiguration._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sandboxJobConfigurationUpdateParams: SandboxJobConfigurationUpdateParams) =
            apply {
                ...
                additionalQueryParams = sandboxJobConfigurationUpdateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "SandboxJobConfigurationUpdateParams{sandboxJobConfiguration=$sandboxJobConfiguration, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
