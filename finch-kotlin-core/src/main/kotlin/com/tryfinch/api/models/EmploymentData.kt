...
@NoAutoDetect
class EmploymentData @JsonCreator private constructor(
    ...
    @JsonProperty("work_id") @ExcludeMissing private val workId: JsonField<String> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(employmentData: EmploymentData) =
            apply {
        ...
        /** This field is deprecated in favour of `source_id` */
        @Deprecated("deprecated")
        fun workId(workId: JsonField<String>) =
            apply {
                this.workId = workId
            }
    ...
    override fun toString() = "EmploymentData{id=$id, classCode=$classCode, customFields=$customFields, department=$department, employment=$employment, employmentStatus=$employmentStatus, endDate=$endDate, firstName=$firstName, income=$income, incomeHistory=$incomeHistory, isActive=$isActive, lastName=$lastName, latestRehireDate=$latestRehireDate, location=$location, manager=$manager, middleName=$middleName, sourceId=$sourceId, startDate=$startDate, title=$title, workId=$workId, additionalProperties=$additionalProperties}"
}
