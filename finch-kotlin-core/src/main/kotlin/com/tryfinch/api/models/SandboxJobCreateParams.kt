...
class SandboxJobCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sandboxJobCreateParams: SandboxJobCreateParams) =
            apply {
    ...
    override fun toString() = "SandboxJobCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
