...
@NoAutoDetect
class JobCompletionEvent @JsonCreator private constructor(
    ...
    fun validate(): JobCompletionEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(jobCompletionEvent: JobCompletionEvent) =
            apply {
    ...
    class Data @JsonCreator private constructor(
        ...
        override fun toString() = "Data{jobId=$jobId, jobUrl=$jobUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "JobCompletionEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
