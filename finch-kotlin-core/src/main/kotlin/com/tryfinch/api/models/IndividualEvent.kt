...
@NoAutoDetect
class IndividualEvent @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(individualEvent: IndividualEvent) =
            apply {
    ...
    override fun toString() = "IndividualEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
