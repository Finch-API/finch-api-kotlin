...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(individualEvent: IndividualEvent) = apply {
            ...
            entityId = individualEvent.entityId
    ...
    override fun toString() =
        "IndividualEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, entityId=$entityId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
