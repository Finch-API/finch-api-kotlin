...
constructor(
    ...
    override fun toString() =
        "PayrollPayGroupListParams{individualId=$individualId, payFrequencies=$payFrequencies, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(payrollPayGroupListParams: PayrollPayGroupListParams) = apply {
            ...
            additionalBodyProperties(payrollPayGroupListParams.additionalBodyProperties)
        }
