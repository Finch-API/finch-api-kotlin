...
class PayrollPayGroupListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.individualId?.let {
          queryParams.put(
            "individual_id", listOf(it.toString())
          )
      }
      this.payFrequencies?.let {
          queryParams.put(
            "pay_frequencies[]", it.map(Any::toString)
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(payrollPayGroupListParams: PayrollPayGroupListParams) =
            apply {
        ...
        fun payFrequencies(payFrequencies: List<String>?) =
            apply {
                this.payFrequencies = payFrequencies?.toMutableList()
            }

        fun addPayFrequency(payFrequency: String) =
            apply {
    ...
    override fun toString() = "PayrollPayGroupListParams{individualId=$individualId, payFrequencies=$payFrequencies, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
