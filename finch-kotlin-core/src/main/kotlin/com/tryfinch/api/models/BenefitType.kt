...
/** Type of benefit. */
class BenefitType @JsonCreator private constructor(
    ...
    /**
     * An enum containing [BenefitType]'s known values, as well as an [_UNKNOWN]
     * member.
     *
    ...
    enum class Value {
        ...
        CUSTOM_PRE_TAX,
        /**
         * An enum member indicating that [BenefitType] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
