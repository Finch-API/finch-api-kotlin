 ...
 * API.
 */
class RequestForwardingForwardParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @ExcludeMissing
        fun _headers_(): JsonValue = headers
        ...
        override fun toString() = "Body{method=$method, route=$route, data=$data, headers=$headers, params=$params, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(requestForwardingForwardParams: RequestForwardingForwardParams) =
            apply {
    ...
    override fun toString() = "RequestForwardingForwardParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
