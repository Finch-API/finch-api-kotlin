 ...
 */
class JobAutomatedCreateParams private constructor(
    ...
    class Body private constructor(
        ...
        fun asW4FormEmployeeSync(): W4FormEmployeeSync = w4FormEmployeeSync.getOrThrow("w4FormEmployeeSync")
        ...
        companion object {
            ...
            fun ofW4FormEmployeeSync(w4FormEmployeeSync: W4FormEmployeeSync) = Body(w4FormEmployeeSync = w4FormEmployeeSync)
        }
        ...
        internal class Deserializer : BaseDeserializer<Body>(Body::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Body {
              ...
              when (type) {
                  "data_sync_all" -> {
                      tryDeserialize(node, jacksonTypeRef<DataSyncAll>()){ it.validate() }?.let {
                          return Body(dataSyncAll = it, _json = json)
                      }
                  }
                  "w4_form_employee_sync" -> {
                      tryDeserialize(node, jacksonTypeRef<W4FormEmployeeSync>()){ it.validate() }?.let {
        ...
        internal class Serializer : BaseSerializer<Body>(Body::class) {
            ...
            override fun serialize(value: Body, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  ...
                  value.w4FormEmployeeSync != null -> generator.writeObject(value.w4FormEmployeeSync)
        ...
        class DataSyncAll @JsonCreator private constructor(
            ...
            override fun toString() = "DataSyncAll{type=$type, additionalProperties=$additionalProperties}"
        }

        @NoAutoDetect
        class W4FormEmployeeSync @JsonCreator private constructor(
            ...
            fun validate(): W4FormEmployeeSync =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            @NoAutoDetect
            class Params @JsonCreator private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(params: Params) =
                        apply {
                ...
                override fun toString() = "Params{individualId=$individualId, additionalProperties=$additionalProperties}"
            }
            ...
            override fun toString() = "W4FormEmployeeSync{params=$params, type=$type, additionalProperties=$additionalProperties}"
        }
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(jobAutomatedCreateParams: JobAutomatedCreateParams) =
            apply {
        ...
        fun body(w4FormEmployeeSync: Body.W4FormEmployeeSync) = body(Body.ofW4FormEmployeeSync(w4FormEmployeeSync))

        fun w4FormEmployeeSyncBody(params: Body.W4FormEmployeeSync.Params) =
            body(Body.W4FormEmployeeSync.builder()
    ...
    override fun toString() = "JobAutomatedCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
