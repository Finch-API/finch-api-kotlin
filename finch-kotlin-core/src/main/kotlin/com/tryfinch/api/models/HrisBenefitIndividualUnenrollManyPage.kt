...
class HrisBenefitIndividualUnenrollManyPage private constructor(
    ...
    override fun toString() = "HrisBenefitIndividualUnenrollManyPage{individualsService=$individualsService, params=$params, response=$response}"
    ...
    fun getNextPage(): HrisBenefitIndividualUnenrollManyPage? {
      return getNextPageParams()?.let {
          individualsService.unenrollMany(it)
      }
    }
    ...
    companion object {
        ...
        fun of(individualsService: IndividualService, params: HrisBenefitIndividualUnenrollManyParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("items") private val items: JsonField<List<UnenrolledIndividual>> = JsonMissing.of(),
        ...
        @JsonProperty("items")
        fun _items(): JsonField<List<UnenrolledIndividual>>? = items
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<UnenrolledIndividual> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
