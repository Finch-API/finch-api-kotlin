...
@NoAutoDetect
class CreateAccessTokenResponse @JsonCreator private constructor(
    ...
    @JsonProperty("token_type") @ExcludeMissing private val tokenType: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _tokenType(): JsonField<String> = tokenType
    ...
    fun validate(): CreateAccessTokenResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(createAccessTokenResponse: CreateAccessTokenResponse) =
            apply {
        ...
        /** The RFC 8693 token type (Finch uses `bearer` tokens) */
        fun tokenType(tokenType: JsonField<String>) =
            apply {
