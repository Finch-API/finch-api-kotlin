...
@NoAutoDetect
class EnrolledIndividual @JsonCreator private constructor(
    ...
    fun validate(): EnrolledIndividual =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(enrolledIndividual: EnrolledIndividual) =
            apply {
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("finch_code") @ExcludeMissing private val finchCode: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A descriptive identifier for the response */
            fun finchCode(finchCode: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{finchCode=$finchCode, message=$message, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    class Code @JsonCreator private constructor(
        ...
        fun asLong(): Long =
            _value().asNumber()
                ?.let { if (it.toDouble() % 1 == 0.0) it.toLong() else null }
    ...
    override fun toString() = "EnrolledIndividual{body=$body, code=$code, individualId=$individualId, additionalProperties=$additionalProperties}"
}
