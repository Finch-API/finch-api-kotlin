...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PayrollPayGroupListPage && this.payGroupsService == other.payGroupsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(payGroupsService, params, response) /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "PayrollPayGroupListPage.Response{items=$items, additionalProperties=$additionalProperties}"
