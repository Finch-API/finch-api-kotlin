 ...
 */
class HrisDocumentListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.individualIds?.let {
          queryParams.put(
            "individual_ids[]", it.map(Any::toString)
          )
      }
      this.limit?.let {
          queryParams.put(
      ...
      this.offset?.let {
          queryParams.put(
            "offset", listOf(it.toString())
          )
      }
      this.types?.let {
          queryParams.put(
            "types[]", it.map(Any::toString)
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisDocumentListParams: HrisDocumentListParams) =
            apply {
    ...
    override fun toString() = "HrisDocumentListParams{individualIds=$individualIds, limit=$limit, offset=$offset, types=$types, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
