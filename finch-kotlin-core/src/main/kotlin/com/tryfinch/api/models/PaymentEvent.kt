...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentEvent: PaymentEvent) = apply {
            ...
            entityId = paymentEvent.entityId
    ...
    override fun toString() =
        "PaymentEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, entityId=$entityId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
