...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is PaymentIdentifiers && this.paymentId == other.paymentId && this.payDate == other.payDate && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            val PAYMENT_CREATED = EventType(JsonField.of("payment.created"))

            val PAYMENT_UPDATED = EventType(JsonField.of("payment.updated"))

            val PAYMENT_DELETED = EventType(JsonField.of("payment.deleted"))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PaymentEvent && this.connectionId == other.connectionId && this.companyId == other.companyId && this.accountId == other.accountId && this.eventType == other.eventType && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
