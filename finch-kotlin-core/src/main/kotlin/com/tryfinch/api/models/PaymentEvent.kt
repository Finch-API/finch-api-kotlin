...
@NoAutoDetect
class PaymentEvent @JsonCreator private constructor(
    ...
    @JsonProperty("data") @ExcludeMissing private val data: JsonField<PaymentIdentifiers> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<PaymentIdentifiers> = data
    ...
    class Builder internal constructor() {
        ...
        internal fun from(paymentEvent: PaymentEvent) =
            apply {
        ...
        fun data(data: JsonField<PaymentIdentifiers>) =
            apply {
                this.data = data
            }
    ...
    @NoAutoDetect
    class PaymentIdentifiers @JsonCreator private constructor(
        @JsonProperty("pay_date") @ExcludeMissing private val payDate: JsonField<String> = JsonMissing.of(),
        @JsonProperty("payment_id") @ExcludeMissing private val paymentId: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        fun validate(): PaymentIdentifiers =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        class Builder internal constructor() {
            ...
            internal fun from(paymentIdentifiers: PaymentIdentifiers) =
                apply {
        ...
        override fun toString() = "PaymentIdentifiers{payDate=$payDate, paymentId=$paymentId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "PaymentEvent{accountId=$accountId, companyId=$companyId, connectionId=$connectionId, data=$data, eventType=$eventType, additionalProperties=$additionalProperties}"
}
