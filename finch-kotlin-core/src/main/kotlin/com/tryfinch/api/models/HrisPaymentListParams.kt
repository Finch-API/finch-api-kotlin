...
class HrisPaymentListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.endDate.let {
          queryParams.put(
            "end_date", listOf(it.toString())
          )
      }
      this.startDate.let {
          queryParams.put(
            "start_date", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisPaymentListParams: HrisPaymentListParams) =
            apply {
    ...
    override fun toString() = "HrisPaymentListParams{endDate=$endDate, startDate=$startDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
