...
class HrisEmploymentRetrieveManyPage private constructor(
    ...
    override fun toString() = "HrisEmploymentRetrieveManyPage{employmentsService=$employmentsService, params=$params, response=$response}"
    ...
    fun getNextPage(): HrisEmploymentRetrieveManyPage? {
      return getNextPageParams()?.let {
          employmentsService.retrieveMany(it)
      }
    }
    ...
    companion object {
        ...
        fun of(employmentsService: EmploymentService, params: HrisEmploymentRetrieveManyParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("responses") private val responses: JsonField<List<EmploymentDataResponse>> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

    ) {

        fun responses(): List<EmploymentDataResponse> = responses.getNullable("responses") ?: listOf()
        ...
        class Builder {
            ...
            fun responses(responses: JsonField<List<EmploymentDataResponse>>) = apply { this.responses = responses }
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<EmploymentDataResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
