...
@NoAutoDetect
class ConnectionCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): ConnectionCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(connectionCreateResponse: ConnectionCreateResponse) =
            apply {
    ...
    override fun toString() = "ConnectionCreateResponse{accessToken=$accessToken, accountId=$accountId, authenticationType=$authenticationType, companyId=$companyId, connectionId=$connectionId, products=$products, providerId=$providerId, tokenType=$tokenType, additionalProperties=$additionalProperties}"
}
