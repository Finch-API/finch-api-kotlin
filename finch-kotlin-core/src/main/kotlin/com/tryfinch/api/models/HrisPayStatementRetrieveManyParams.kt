 ...
 * supports Benefits.
 */
class HrisPayStatementRetrieveManyParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(hrisPayStatementRetrieveManyParams: HrisPayStatementRetrieveManyParams) =
            apply {
                ...
                additionalQueryParams = hrisPayStatementRetrieveManyParams.additionalQueryParams.toBuilder()
            }
    ...
    class Request @JsonCreator private constructor(
        ...
        override fun toString() = "Request{paymentId=$paymentId, limit=$limit, offset=$offset, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "HrisPayStatementRetrieveManyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
