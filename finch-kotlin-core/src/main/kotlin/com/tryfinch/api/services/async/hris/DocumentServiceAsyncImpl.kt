...
class DocumentServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: HrisDocumentListParams, requestOptions: RequestOptions): DocumentListResponse =
        // get /employer/documents
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun retreive(params: HrisDocumentRetreiveParams, requestOptions: RequestOptions): DocumentRetreiveResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: HrisDocumentListParams, requestOptions: RequestOptions): HttpResponseFor<DocumentListResponse> {
        ...
        override suspend fun retreive(params: HrisDocumentRetreiveParams, requestOptions: RequestOptions): HttpResponseFor<DocumentRetreiveResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
