...
interface ManualServiceAsync {
     ...
     */
    suspend fun retrieve(params: JobManualRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): ManualAsyncJob
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: JobManualRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ManualAsyncJob>
    }
}
