...
interface AutomatedService {
     ...
     */
    fun list(params: JobAutomatedListParams = JobAutomatedListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AutomatedListResponse

    /** @see [list] */
    fun list(requestOptions: RequestOptions): AutomatedListResponse = list(JobAutomatedListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: JobAutomatedListParams = JobAutomatedListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AutomatedListResponse>

        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<AutomatedListResponse> = list(JobAutomatedListParams.none(), requestOptions)
    }
}
