...
interface SessionService {
    ...
    fun new(params: ConnectSessionNewParams, requestOptions: RequestOptions = RequestOptions.none()): SessionNewResponse
    ...
    interface WithRawResponse {
         ...
         * same as [SessionService.new].
         */
        @MustBeClosed
        fun new(params: ConnectSessionNewParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SessionNewResponse>
