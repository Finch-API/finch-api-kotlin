...
interface CompanyServiceAsync {
    ...
    suspend fun update(params: SandboxCompanyUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompanyUpdateResponse
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun update(params: SandboxCompanyUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CompanyUpdateResponse>
    }
}
