...
class BenefitServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BenefitServiceAsync {

    private val withRawResponse: BenefitServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override suspend fun create(params: HrisBenefitCreateParams, requestOptions: RequestOptions): CreateCompanyBenefitsResponse =
        // post /employer/benefits
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: HrisBenefitRetrieveParams, requestOptions: RequestOptions): CompanyBenefit =
        // get /employer/benefits/{benefit_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: HrisBenefitUpdateParams, requestOptions: RequestOptions): UpdateCompanyBenefitResponse =
        // post /employer/benefits/{benefit_id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: HrisBenefitListParams, requestOptions: RequestOptions): HrisBenefitListPageAsync =
        // get /employer/benefits
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun listSupportedBenefits(params: HrisBenefitListSupportedBenefitsParams, requestOptions: RequestOptions): HrisBenefitListSupportedBenefitsPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: HrisBenefitCreateParams, requestOptions: RequestOptions): HttpResponseFor<CreateCompanyBenefitsResponse> {
        ...
        override suspend fun retrieve(params: HrisBenefitRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CompanyBenefit> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: HrisBenefitUpdateParams, requestOptions: RequestOptions): HttpResponseFor<UpdateCompanyBenefitResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("employer", "benefits", params.getPathParam(0))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override suspend fun list(params: HrisBenefitListParams, requestOptions: RequestOptions): HttpResponseFor<HrisBenefitListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("employer", "benefits")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  HrisBenefitListPageAsync.of(BenefitServiceAsyncImpl(clientOptions), params, HrisBenefitListPageAsync.Response.builder()
                      .items(it)
                      .build())
              }
          }
        ...
        override suspend fun listSupportedBenefits(params: HrisBenefitListSupportedBenefitsParams, requestOptions: RequestOptions): HttpResponseFor<HrisBenefitListSupportedBenefitsPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  HrisBenefitListSupportedBenefitsPageAsync.of(BenefitServiceAsyncImpl(clientOptions), params, HrisBenefitListSupportedBenefitsPageAsync.Response.builder()
                      .items(it)
                      .build())
              }
          }
