...
interface AutomatedServiceAsync {
     ...
     */
    suspend fun create(params: JobAutomatedCreateParams = JobAutomatedCreateParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AutomatedCreateResponse

    /** @see [create] */
    suspend fun create(requestOptions: RequestOptions): AutomatedCreateResponse = create(JobAutomatedCreateParams.none(), requestOptions)

    /** Get an automated job by `job_id`. */
    suspend fun retrieve(params: JobAutomatedRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): AutomatedAsyncJob
     ...
     */
    suspend fun list(params: JobAutomatedListParams = JobAutomatedListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AutomatedListResponse

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): AutomatedListResponse = list(JobAutomatedListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: JobAutomatedCreateParams = JobAutomatedCreateParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AutomatedCreateResponse>

        /** @see [create] */
        @MustBeClosed
        suspend fun create(requestOptions: RequestOptions): HttpResponseFor<AutomatedCreateResponse> = create(JobAutomatedCreateParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: JobAutomatedRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AutomatedAsyncJob>
         ...
         */
        @MustBeClosed
        suspend fun list(params: JobAutomatedListParams = JobAutomatedListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AutomatedListResponse>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<AutomatedListResponse> = list(JobAutomatedListParams.none(), requestOptions)
    }
}
