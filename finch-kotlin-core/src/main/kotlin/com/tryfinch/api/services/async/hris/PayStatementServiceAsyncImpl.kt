...
class PayStatementServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieveMany(params: HrisPayStatementRetrieveManyParams, requestOptions: RequestOptions): HrisPayStatementRetrieveManyPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun retrieveMany(params: HrisPayStatementRetrieveManyParams, requestOptions: RequestOptions): HttpResponseFor<HrisPayStatementRetrieveManyPageAsync> {
