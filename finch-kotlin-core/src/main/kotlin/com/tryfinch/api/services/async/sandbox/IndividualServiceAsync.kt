...
interface IndividualServiceAsync {
    ...
    suspend fun update(params: SandboxIndividualUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): IndividualUpdateResponse
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun update(params: SandboxIndividualUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<IndividualUpdateResponse>
    }
}
