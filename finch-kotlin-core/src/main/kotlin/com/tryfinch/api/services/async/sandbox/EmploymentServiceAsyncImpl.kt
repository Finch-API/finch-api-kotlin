...
class EmploymentServiceAsyncImpl internal constructor(
    ...
    override suspend fun update(params: SandboxEmploymentUpdateParams, requestOptions: RequestOptions): EmploymentUpdateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun update(params: SandboxEmploymentUpdateParams, requestOptions: RequestOptions): HttpResponseFor<EmploymentUpdateResponse> {
