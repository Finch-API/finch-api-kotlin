...
class PaymentServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: HrisPaymentListParams, requestOptions: RequestOptions): HrisPaymentListPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: HrisPaymentListParams, requestOptions: RequestOptions): HttpResponseFor<HrisPaymentListPageAsync> {
          ...
          return response.parseable {
              ...
              .let {
                  HrisPaymentListPageAsync.of(PaymentServiceAsyncImpl(clientOptions), params, HrisPaymentListPageAsync.Response.builder()
                      .items(it)
                      .build())
              }
          }
