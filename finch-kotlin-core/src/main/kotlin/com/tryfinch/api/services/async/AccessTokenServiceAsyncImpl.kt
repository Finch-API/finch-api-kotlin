...
class AccessTokenServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: AccessTokenCreateParams, requestOptions: RequestOptions): CreateAccessTokenResponse =
        // post /auth/token
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: AccessTokenCreateParams, requestOptions: RequestOptions): HttpResponseFor<CreateAccessTokenResponse> {
