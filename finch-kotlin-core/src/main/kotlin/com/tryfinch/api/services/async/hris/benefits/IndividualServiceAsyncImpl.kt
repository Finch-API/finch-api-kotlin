...
class IndividualServiceAsyncImpl internal constructor(
    ...
    override suspend fun enrolledIds(params: HrisBenefitIndividualEnrolledIdsParams, requestOptions: RequestOptions): IndividualEnrolledIdsResponse =
        // get /employer/benefits/{benefit_id}/enrolled
        withRawResponse().enrolledIds(params, requestOptions).parse()

    override suspend fun retrieveManyBenefits(params: HrisBenefitIndividualRetrieveManyBenefitsParams, requestOptions: RequestOptions): HrisBenefitIndividualRetrieveManyBenefitsPageAsync =
        // get /employer/benefits/{benefit_id}/individuals
        withRawResponse().retrieveManyBenefits(params, requestOptions).parse()

    override suspend fun unenrollMany(params: HrisBenefitIndividualUnenrollManyParams, requestOptions: RequestOptions): HrisBenefitIndividualUnenrollManyPageAsync =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun enrolledIds(params: HrisBenefitIndividualEnrolledIdsParams, requestOptions: RequestOptions): HttpResponseFor<IndividualEnrolledIdsResponse> {
        ...
        override suspend fun retrieveManyBenefits(params: HrisBenefitIndividualRetrieveManyBenefitsParams, requestOptions: RequestOptions): HttpResponseFor<HrisBenefitIndividualRetrieveManyBenefitsPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
          ...
          return response.parseable {
              ...
              .let {
                  HrisBenefitIndividualRetrieveManyBenefitsPageAsync.of(IndividualServiceAsyncImpl(clientOptions), params, HrisBenefitIndividualRetrieveManyBenefitsPageAsync.Response.builder()
                      .items(it)
                      .build())
              }
          }
        ...
        override suspend fun unenrollMany(params: HrisBenefitIndividualUnenrollManyParams, requestOptions: RequestOptions): HttpResponseFor<HrisBenefitIndividualUnenrollManyPageAsync> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  HrisBenefitIndividualUnenrollManyPageAsync.of(IndividualServiceAsyncImpl(clientOptions), params, HrisBenefitIndividualUnenrollManyPageAsync.Response.builder()
                      .items(it)
                      .build())
              }
          }
