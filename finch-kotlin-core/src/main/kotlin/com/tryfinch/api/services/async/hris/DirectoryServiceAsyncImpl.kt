...
class DirectoryServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: HrisDirectoryListParams, requestOptions: RequestOptions): HrisDirectoryListPageAsync =
        // get /employer/directory
        withRawResponse().list(params, requestOptions).parse()

    @Deprecated("use `list` instead")
    override suspend fun listIndividuals(params: HrisDirectoryListIndividualsParams, requestOptions: RequestOptions): HrisDirectoryListIndividualsPageAsync =
        // get /employer/directory
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: HrisDirectoryListParams, requestOptions: RequestOptions): HttpResponseFor<HrisDirectoryListPageAsync> {
        ...
        @Deprecated("use `list` instead")
        override suspend fun listIndividuals(params: HrisDirectoryListIndividualsParams, requestOptions: RequestOptions): HttpResponseFor<HrisDirectoryListIndividualsPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("employer", "directory")
            .build()
